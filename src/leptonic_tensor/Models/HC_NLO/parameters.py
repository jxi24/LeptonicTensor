...
#**********************************************************#
# NEW
# Higgs Characterisation -  mass and width of X0
#**********************************************************#
...
ymuon = Parameter(name = 'ymuon',
               nature = 'internal',
               type = 'real',
               value = '(ymmuon*cmath.sqrt(2))/vev',
               texname = '\\text{ymuon}')
...
#**********************************************************#
# NEW
# Higgs Characterisation parameters
#**********************************************************#
...
#NEW
kHcc = Parameter(name = 'kHcc',
                 nature = 'external',
                 type = 'real',
                 value = 1,
                 texname = '\\kappa _{\\text{Hcc}}',
                 lhablock = 'FRBlock',
                 lhacode = [ 100 ])

#NEW
kAcc = Parameter(name = 'kAcc',
                 nature = 'external',
                 type = 'real',
                 value = 1,
                 texname = '\\kappa _{\\text{Acc}}',
                 lhablock = 'FRBlock',
                 lhacode = [ 101 ])
